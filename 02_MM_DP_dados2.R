...
###### Lendo dados
##
#caminho<-"/Users/Daiane/Downloads/associated/"
...
#
	...
	if (int>burnin & int%%saltos==0){
		cat('',Sj,file=paste(caminho,"Sj_associated.txt",sep=""),append=T)
		cat('',alpha,file=paste(caminho,"Alpha_associated.txt",sep=""),append=T)}
}
